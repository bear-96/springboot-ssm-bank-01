...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="css/bankTop.css">
	<!--  link rel="stylesheet" href="<%=path %>/css/body.css" type="text/css" -->
  </head>
 <body>
    <div class="bankTop">
        ...
        <div class="bankTop_Menu">
            <ul>
                <li><a style="width:150px;color: firebrick ;text-shadow: 0px 1px 2px firebrick;" >首页</a></li>
