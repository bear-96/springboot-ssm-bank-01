...
<style>	
  ...
  <div style="width:20%;height:200px;background-color:#FFFFFF;border: 1.5px solid #eeeeee;">
  		...
  		<font style="font-family:楷体;color:#FFFFFF;text-shadow: 0px 1px 2px #eeeeee;">取款</font>
  		</ul>
  		<form action="/withdrawals" method="post">
  		<input type="text" name="money" placeholder="请输入取款金额"/></input><br>
